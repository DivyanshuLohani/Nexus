  ...
  return (
    <section className="border-b">
      <div className="px-10 py-12">
        ...
        <h2 className="text-3xl font-bold mt-2">ENGINEERED FOR IMPACT</h2>
      </div>

      <div className="grid md:grid-cols-3 border-t">
        {items.map((item, i) => (
          <div key={i} className="p-8 border-r last:border-r-0 border-border">
            <div className="w-8 h-8 bg-primary text-primary-foreground flex items-center justify-center mb-4">
              {item.icon}
            </div>
