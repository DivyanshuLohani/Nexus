      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-card-foreground">
          <section>
            ...
            <p>
              We collect basic account information such as your email, username,
              and profile data when you create an account. We may also collect
              usage data such as page views and interactions.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We collect anonymized analytics such as page views, device type,
              and referrer data to help improve the platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              third-party services strictly for infrastructure and analytics.
            </p>
          </section>

          <section>
            <h2 className="font-semibold mb-2">5. Security</h2>
            <p>
          ...
          <section>
            ...
            <p>If you have questions, contact us at support@Nexus.app</p>
          </section>
        </div>
      </div>
    </main>
